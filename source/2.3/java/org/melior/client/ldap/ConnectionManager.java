...
/**
 * Implements a manager for persistent LDAP {@code Connection} objects, for connections to
 * LDAP servers. The manager writes statistics from the underlying connection pool to
